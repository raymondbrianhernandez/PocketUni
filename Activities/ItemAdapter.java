...
public class ItemAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ItemAdapter(Context context, ArrayList<Object> itemList) {
...
//        holder.item_courses.setText(subj.trim());
        ...
        holder.mail.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                emailIntent.putExtra(Intent.EXTRA_EMAIL, new String[]{holder.email});
                try {
                    mContext.startActivity(emailIntent);
                }
                catch (android.content.ActivityNotFoundException ex) {
                    Toast.makeText(mContext, "Uh oh...No email app?", Toast.LENGTH_SHORT).show();
                }
            }
        });
        holder.cardView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(mContext, RatingProfessorActivity.class);
                intent.putExtra("Name", holder.item_name.getText());
                intent.putExtra("Courses", courseArray);
    ...
    public void configureBookViewHolder(final BookViewHolder holder, int position) {
        ...
        holder.bookCardView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(mContext, RatingBookActivity.class);
                intent.putExtra("Name", holder.book_name.getText());
                mContext.startActivity(intent);
            }
        });
    }
